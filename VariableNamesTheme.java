...
public class VariableNamesTheme {
    public static void main(String[] args) {
        ...
        // вес собаки
        double dogWeight = 20.5;
        System.out.println("вес собаки = " + dogWeight);

        // исходное число
        int startNumber = 0;
        System.out.println("исходное число = " + startNumber);
        ...
        // тип сообщения
        String messageType = "FileNotFound";
        ...
        // стоимость кофе
        double coffeePrice = 2.9;
        System.out.println("стоимость кофе = " + coffeePrice);

        // начальная дата
        LocalDate startDate = LocalDate.of(1989, 11, 13);
